...
| Doc | Role |
|-----|------|
| [`docs/contracts/ARCHITECTURE_CONTRACT.md`](docs/contracts/ARCHITECTURE_CONTRACT.md) | **v0.3.7** — process, paths, imports, stack; P3 local subset (ADR 0006); **P3.1/P3.2** (ADR 0008/0009); **P3.3 AgentTool Docker sandbox (ADR 0011)**; P4 references/workflow (ADR 0007/0010) |
...
| [`docs/features/agent_tool_sandbox_v1.md`](docs/features/agent_tool_sandbox_v1.md) | AgentTool sandbox **frozen v0.1.31**（P3.3；G1–G30；Poirot transplant-first；plan active） |
...
1. Read this file + architecture contract v0.3.7 + the active frozen feature/plan.
