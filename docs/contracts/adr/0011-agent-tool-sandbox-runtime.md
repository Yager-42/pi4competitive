...
- **status:** partially superseded by ADR 0013（Docker-specific decisions historical；provider-neutral executor/RPC/scope preserved）
- **date:** 2026-07-31
...
> **2026-08-02 supersession:** [`ADR 0013`](0013-native-agent-tool-sandbox-runtime.md) supersedes this ADR and Amendment 0011-A for Docker provider/backend/runtime/image/lifecycle/resource/live gates. The provider-neutral `AgentToolExecutor`, approved registry, JSON RPC, parent scope/workspace and no-host-fallback decisions remain inherited by ADR 0013. Do not continue the Docker implementation plan.
