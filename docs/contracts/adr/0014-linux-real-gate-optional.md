...
ADR 0013 要求 P3.3 关闭前 Linux amd64 与 arm64 macOS 都通过真实 enforcement gate（S1–S9）。当前唯一可用开发/验收主机是 arm64 macOS（Darwin 24.3.0，Apple M4）：
...
- 被修订决策的原始 ADR: [`0013-native-agent-tool-sandbox-runtime.md`](0013-native-agent-tool-sandbox-runtime.md)
