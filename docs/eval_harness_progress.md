...
### 4.6 运行指标全量数据（两轨 5-case）

**DRB II 5-case 逐 case 运行指标**（`operations.json`，A2 为 plan→search→write 全链路）：

| case | var | search | fetch | tools | 成功率 | 耗时(s) | 域名 | evidence | p_tok | c_tok |
|---|---|---|---|---|---|---|---|---|---|---|
| drb2_18 | a1 | 0 | 0 | 0 | 0.000 | 82 | 0 | 0 | 702 | 4438 |
| drb2_22 | a1 | 0 | 0 | 0 | 0.000 | 91 | 0 | 0 | 971 | 4884 |
| drb2_30 | a1 | 0 | 0 | 0 | 0.000 | 78 | 0 | 0 | 959 | 4236 |
| drb2_4 | a1 | 0 | 0 | 0 | 0.000 | 32 | 0 | 0 | 0 | 0 |
| drb2_6 | a1 | 0 | 0 | 0 | 0.000 | 98 | 0 | 0 | 988 | 5316 |
| drb2_18 | a2 | 116 | 57 | 173 | 0.208 | 612 | 9 | 33 | 260K | 64K |
| drb2_22 | a2 | 141 | 98 | 239 | 0.264 | 534 | 22 | 52 | 344K | 38K |
| drb2_30 | a2 | 141 | 61 | 202 | 0.252 | 940 | 13 | 48 | 487K | 70K |
| drb2_4 | a2 | 188 | 155 | 343 | 0.335 | 924 | 171 | 335 | 2.0M | 78K |
| drb2_6 | a2 | 129 | 53 | 182 | 0.154 | 653 | 4 | 22 | 282K | 56K |

**DRB II 汇总**：a2 均 tool 227.8 / 成功率 **0.243** / 732.6s / 43.8 域 / 98 evidence / 3.7M tokens；a1 全 0 工具调用；`mean_total a1=0.245 a2=0.361 delta=+0.117`

**WideSearch 5-case 逐 case 运行指标**：

| case | var | search | fetch | tools | 成功率 | 耗时(s) | 域名 | evidence | p_tok | c_tok |
|---|---|---|---|---|---|---|---|---|---|---|
| ws_en_002 | a1 | 0 | 0 | 0 | 0.000 | 53 | 0 | 0 | 414 | 2822 |
| ws_en_004/007/008/011 | a1 | 0 | 0 | 0 | 0.000 | 32-33 | 0 | 0 | 0 | 0 |
| ws_en_002 | a2 | 30 | 23 | 53 | 0.811 | 266 | 57 | 109 | 592K | 13K |
| ws_en_004 | a2 | 17 | 13 | 30 | 0.900 | 213 | 33 | 107 | 1.17M | 9K |
| ws_en_007 | a2 | 19 | 19 | 38 | 0.789 | 249 | 38 | 100 | 574K | 10K |
| ws_en_008 | a2 | 34 | 41 | 75 | 0.813 | 191 | 59 | 159 | 1.7M | 11K |
| ws_en_011 | a2 | 33 | 24 | 57 | 0.632 | 180 | 60 | 134 | 688K | 9K |

**WideSearch 汇总**：a2 均 tool 50.6 / 成功率 **0.789** / 219.9s / 49.4 域 / 121.8 evidence / 4.8M tokens；a1 全 0 工具调用。

**运行指标揭示的关键事实**：
1. **A1 从未调用工具**（两轨全 0）——裸 agent 直接答，是 A1 基线差/空报告的根本（非搜索失败，是压根没用工具）
2. **DRB II a2 工具成功率仅 15-34%**（drb2_6 最低 0.154 ↔ 22 evidence ↔ recall 0.188）——搜索基建是 DRB II 短板，直接解释 recall 低
3. **WideSearch a2 成功率 63-90%**（anysearch 工作良好）↔ 对应非零 F1（0.129）
4. **token 消耗差异大**：drb2_4 a2 单 case 2.0M prompt tokens（343 次工具调用）
5. **cost 全 0**（网关不报价格）；**fallback 全 0**（无 fallback 链）
