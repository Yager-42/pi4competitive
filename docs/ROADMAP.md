...
| P3.3 AgentTool sandbox | **in_progress** | | ADR 0012 / contract v0.3.9；native feature v0.2.1；plan v0.1.1；**G0 complete：source/integrity/license/seccomp/removal/CodeGraph/test map + offline 406 green**；A–F/V1–V4 not started；P4 AgentTool-dependent expansion 保持暂停 |
