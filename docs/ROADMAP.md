...
| **P3.3 AgentTool sandbox** | **todo；feature frozen；plan active** | [`agent_tool_sandbox_v1.md`](features/agent_tool_sandbox_v1.md) **v0.1.31 frozen**；[`P3_3_agent_tool_sandbox.md`](plans/P3_3_agent_tool_sandbox.md) **v0.1.0 todo**；ADR 0011 |
...
| **实现计划** | [`P3_3_agent_tool_sandbox.md`](plans/P3_3_agent_tool_sandbox.md) **v0.1.0 todo**；A–F 串行，plan 外实现禁止 |
...
| P3.3 AgentTool sandbox | **todo** | | feature v0.1.31 frozen；plan v0.1.0 todo；ADR 0011 / contract v0.3.7；G0 preflight done，implementation 未开始；P4 AgentTool-dependent expansion paused |
