...
| **date** | 2026-08-02 |
| **plan** | [`P3_3_agent_tool_native_sandbox.md`](P3_3_agent_tool_native_sandbox.md) v0.1.7 |
| **ADR** | [`0013-native-agent-tool-sandbox-runtime.md`](../contracts/adr/0013-native-agent-tool-sandbox-runtime.md) |
| **feature** | [`agent_tool_native_sandbox_v1.md`](../features/agent_tool_native_sandbox_v1.md) v0.2.3 |
...
> ADR 0014 (2026-08-03, contract v0.3.11, feature v0.2.3, plan v0.1.7; 分支内原编号 ADR 0013，合并重编号):
...
> (same-host arm64 macOS vs the frozen ADR 0013 Docker baseline: cold
...
| `tests/competitive_app/contract/test_sandbox_contract.py` and package dependency contracts | ADAPT to ADR 0013 |
