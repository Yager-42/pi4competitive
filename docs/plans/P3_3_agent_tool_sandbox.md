...
| **plan_version** | `0.1.3` |
| **status** | **superseded historical — ADR 0013 replaces Docker plan；F3 cancelled as obsolete** |
| **created** | 2026-07-31 |
| **updated** | 2026-08-02 |
| **roadmap** | [`docs/ROADMAP.md`](../ROADMAP.md) stage **P3.3** |
| **contract** | historical v0.3.8；current contract v0.3.9 / ADR 0013 |
| **feature** | [`docs/features/agent_tool_sandbox_v1.md`](../features/agent_tool_sandbox_v1.md) **v0.1.33 superseded historical** |
| **ADR** | historical ADR 0011 + 0011-A；superseded by [`0013-native-agent-tool-sandbox-runtime.md`](../contracts/adr/0013-native-agent-tool-sandbox-runtime.md) |
...
| Version | Date | Change |
|---------|------|--------|
| `0.1.3` | 2026-08-02 | ADR 0013 superseded this Docker plan；F3 cancelled；native replacement plan v0.1.0 becomes active；completed provider-neutral seam/RPC/registry/scope work is retained as migration input |
