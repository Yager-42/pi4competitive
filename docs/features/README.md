...
| [`agent_tool_sandbox_v1.md`](agent_tool_sandbox_v1.md) | `agent-tool-sandbox-v1` | **superseded historical** v0.1.33；ADR 0011/0011-A Docker record | [`P3_3_agent_tool_sandbox.md`](../plans/P3_3_agent_tool_sandbox.md) **v0.1.3 superseded**；provider-neutral outputs inherited by ADR 0012 |
| [`agent_tool_native_sandbox_v1.md`](agent_tool_native_sandbox_v1.md) | `agent-tool-native-sandbox-v1` | **frozen** v0.2.1；G1–G10 resolved；G0 complete；ADR 0012 / contract v0.3.9 | [`P3_3_agent_tool_native_sandbox.md`](../plans/P3_3_agent_tool_native_sandbox.md) v0.1.1 active + [`G0 map`](../plans/P3_3_native_sandbox_G0_map.md)；Linux/macOS；native-only |

> 状态板与 changelog 见 [`docs/ROADMAP.md`](../ROADMAP.md)（roadmap v0.1.44 / 架构契约 v0.3.9）。本目录只索引 feature 边界契约。
