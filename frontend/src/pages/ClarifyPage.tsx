/* pi4 ClarifyPage —— 近原样复用 VerdaAI(pi4 ClarifyQuestion 结构已对齐 batch3)。
 * submitClarify 指向 pi4 POST /api/v2/tasks/{id}/clarify;questions 从 HomePage navigate state 取。
 */
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[680px] flex-col justify-center px-6 py-16">
        <motion.div variants={fadeUp} initial="initial" animate="animate" className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div className="text-aux text-ink-2">这能帮助系统更精准地锁定调研范围</div>
          </div>
        </motion.div>
